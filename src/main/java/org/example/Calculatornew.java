...
public class Calculatornew {
    public static void main(String[] args){
        ...
        switch(operator){
            case '+':
               l.log(Level.INFO, () ->"Addition of two numbers: "+c1.calc());
                break;
            case '-':
                  l.log(Level.INFO, () ->"Subtraction of two numbers: "+c2.calc());
                break;
            case '*':
                 l.log(Level.INFO, () ->"Multiplication of two numbers: "+c3.calc());
                break;
            case '/':
